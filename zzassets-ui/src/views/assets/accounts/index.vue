    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p v-for="account in accounts" :key="account.id" v-html="account.html" @click="pop(account.id)"></p>
            <!-- <p>
...
export default {
  ...
  data() {
    return {
      ...
      version: "3.7.0",
      accounts: [
        {"id": "111", "html": "<div class='el-icon-s-promotion' align='right' style='text-align:right'> 现金：100003</div>"},
        {"id": "222", "html": "<div class='el-icon-s-promotion' align='right' style='text-align:right'> 电子现金：1005603</div>"}
      ]
    };
  },
  methods: {
